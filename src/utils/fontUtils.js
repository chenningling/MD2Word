...
export const FONT_MAPPING = {
  ...
  '楷体GB2313': 'KaiTi_GB2312, KaiTi, STKaiti, "Source Serif Pro", serif',
  ...
  '方正黑体 GBK': 'FZHei-GBK, FZHei, Heiti SC, SimHei, "Source Sans Pro", sans-serif',
  '方正楷体 GBK': 'FZKai-GBK, FZKai, KaiTi, STKaiti, "Source Serif Pro", serif',
  '方正仿宋 GBK': 'FZFangSong-GBK, FZFangSong, FangSong, STFangsong, "Source Serif Pro", serif',
  '方正小标宋 GBK': 'FZXiaoBiaoSong-GBK, STZhongsong, SimSun, "Source Serif Pro", serif',
...
export const FONT_OPTIONS = [
  ...
  { value: '方正黑体 GBK', label: '方正黑体 GBK' },
  { value: '方正楷体 GBK', label: '方正楷体 GBK' },
  { value: '方正仿宋 GBK', label: '方正仿宋 GBK' },
  { value: '方正小标宋 GBK', label: '方正小标宋 GBK' },
